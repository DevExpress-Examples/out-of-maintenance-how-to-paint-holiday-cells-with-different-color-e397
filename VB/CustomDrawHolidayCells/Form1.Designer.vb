Namespace CustomDrawHolidayCells
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.schedulerControl1.Start = New DateTime(2008, 8, 18, 0, 0, 0, 0)
...
'ORIGINAL LINE: this.schedulerControl1.CustomDrawTimeCell += new DevExpress.XtraScheduler.CustomDrawObjectEventHandler(this.schedulerControl1_CustomDrawTimeCell);
			' 
			' panel1
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnAddHoliday.Click += new System.EventHandler(this.btnAddHoliday_Click);
			' 
			' Form1
			' 
			...
			Me.Name = "Form1"
			Me.Text = "How to paint holiday cells with different color"
